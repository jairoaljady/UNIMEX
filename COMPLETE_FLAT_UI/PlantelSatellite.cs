...
{
    public partial class PlantelSatellite : Form
    {
        
        public PlantelSatellite()
        {
            InitializeComponent();
            Cargar();
        }
        ...
        {
            MySqlConnection bd = new MySqlConnection("SERVER=localhost; DATABASE=bd_unimex_satellite; UID=root; PASSWORD=; PORT=3306");
            MySqlCommand cmdact;
            bd.Open();
            ...
            try
            {
                ...
                cmdact.CommandText = "UPDATE tb_alumnos_satellite SET AL_NOMBRE=@Nombre, AL_CURP=@CURP, AL_CARRERA=@Carrera, AL_PLANTEL=@Plantel, AL_ESTATUS=@Estatus, AL_TELEFONO=@Telefono, AL_EMAIL=@Email WHERE AL_ID=@ID";
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmdEliminar.CommandText = "DELETE FROM tb_alumnos_satellite WHERE AL_ID=@ID";
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "INSERT INTO tb_alumnos_satellite(AL_NOMBRE,AL_CURP,AL_CARRERA,AL_PLANTEL,AL_ESTATUS,AL_TELEFONO,AL_EMAIL)VALUES(@Nombre,@CURP,@Carrera,@Plantel,@Estatus,@Telefono,@Email)";
        ...
        public void Cargar()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "SELECT * FROM tb_alumnos_satellite";
